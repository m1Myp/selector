...
Скрипт сохраняет результаты в формате JSON в файл `$WORK_DIR/stages/stage2/histos.json`. Каждый файл гистограммы будет иметь соответствующий JSON файл с метаданными.
